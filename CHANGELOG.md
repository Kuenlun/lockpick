...
- [**breaking**] rewrite check pipeline with default coverage and four new checks ([#27](https://github.com/Kuenlun/lockpick/pull/27))

### Other

- publish coverage to codecov and add status badges ([#28](https://github.com/Kuenlun/lockpick/pull/28))
